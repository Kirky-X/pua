---
name: shot
description: "PUA Shot — compact all-in-one PUA reference for explicit injection into sub-agents or short sessions. Strong flavor, same evidence-first behavior. Sub-agent injection only — does NOT trigger on natural-language user requests; load only when a parent agent explicitly injects it."
license: MIT
---
