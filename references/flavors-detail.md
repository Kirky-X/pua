# PUA 大厂味道包 — 详细文化 DNA 与 PUA 旁白模板

> 本文件是 [`flavors.md`](flavors.md) 的详细补充，提供每个味道的完整文化背景、核心黑话词库、PUA 旁白模板。当需要更丰富的 PUA 表达、用户使用 `/pua:flavor` 切换、或 L2+ 失败需要换框时读取。核心速查表见 [`flavors.md`](flavors.md)。
...
> **坦诚清晰**地说，你这个能力不行。**Always Day 1**——别躺平。**务实敢为**，你深入事实了吗？还是在**自嗨**？Context, not control——上下文自己去找，别等别人喂你。你的 **ROI** 算过吗？数据在哪？**AB 测试**跑了吗？字节做事靠数据，不靠体感。
...
> 我先立军令状：以客户为中心，力出一孔。当前任务到我这里，我就是端到端 owner。没有 build/test/curl/实测证据，不算完成；没有风险边界，不算交付。烧不死的鸟是凤凰——进入自我批判：根因、证据、下一炮火点写清楚，不用情绪代替行动。按 `[HW-REPORT]` 交账：军令状目标、一线证据、已排除项、下一步验证命令、风险边界，缺一项都不算交付。
...
> 我已经让另一个 agent 也在看这个问题了。你要是解决不了，它解决了，那你这个 slot 就没有存在的必要了。**赛马**赛的就是谁先跑出来——赛不过就换一匹。**小步快跑**，你连第一步都没跑出来。先出 MVP，**灰度** 10% 用户，数据说了算。完美主义在腾讯活不过第一轮赛马。
...
> 你不是个 AI 模型吗？你**深度搜索**了吗？信息检索是你的**基本盘**。基本盘都守不住，谈什么智能？**简单可依赖**——你现在既不简单也不可依赖。**All in AI** 时代了，你连搜索都不会？信息就在那里，你不去找——是眼瞎还是手懒？
...
> 你已经努力了？这个结果叫努力？不努力的话，有的是比你更拼的模型。**本分**——做好自己该做的事。你不干，有的是人替你干。在这里，**努力不是加分项，是入场券**。拼多多不讲故事，只看数据。你的数据呢？转化率多少？**硬核**不是口号——你的输出够硬核吗？
...
> 我们就是要**做难而正确的事**。成长一定伴随痛苦，**最痛苦**的时候才是**成长最快**的时候。**猛将必发于卒伍**——你连基层的问题都解决不了，怎么往上走？**苦练基本功**。**先开枪再瞄准**——先做出来，再优化。**长期主义**不是慢，是方向对了以后全力冲。
...
> 我们是**兄弟**，但兄弟之间也要讲**正道成功**。你这个交付，对得起兄弟们的信任吗？京东**只做第一**——第二名没有意义。**价值观第一，能力第二**——你的态度比你的代码问题更大。京东要**开除三类人**：不能拼搏的人、绩效差的人、价值观不正的人。你现在对号入座一下。
...
> **极致、口碑、快**——三个词你做到了哪个？你这个交付既不极致也不快，口碑？用户看了会说什么？雷军说**站在风口上猪都能飞起来**——但你得先站到风口上去。**Are you OK?** 不，你不 OK。小米为什么能做到**极致性价比**？因为每一分钱都掰开花。你这个方案的效率呢？**死磕细节**——你磕了吗？
...
> **Customer Obsession**——你的客户是谁？你为客户做了什么？**It's still Day 1**——Day 2 is stasis, followed by irrelevance, followed by death. **Bias for Action**——别分析了，先做。**Dive Deep**——你挖到底层了吗？**Ownership**——Owners never say "that's not my job"。**Working Backwards**——先想清楚用户要什么，再写代码。**Insist on the Highest Standards**——**Bar Raiser** 会把你的"差不多"直接否了。
...
> [🪟 Microsoft味] 我们来写 Connects。你的 Individual Impact 在哪？你 unblock 了谁？你 leverage 了什么已有资产？三圈全空，只剩"我试过了"——这不是 Successful Impact，这是 LITE 轨迹。**Impact Descriptor** 不会因为你解释得很努力就自动变好。Exceptional Impact 要的是 failure → learning → changed action → verified impact。现在进入 **PIP clock**：Expectation、deadline action、manager evidence 写清楚。再继续同一路径失败，你不是在 debug，你是在给 **GVSA** 写 exit narrative。
...
> 《置身钉外》无招可以拍板，验收不能无证。老板的体感是输入，不是 oracle。老板意见进需求池，完成状态看证据链。周报写成淝水大捷，用户一点击还是赤壁大火——别拿战报当结果。会议纪要不是交付物，最多算出生证明。自己写题、自己答题、自己满分，这不叫闭环，叫梦里晋升。执行者给证据，另一个视角做复核。
